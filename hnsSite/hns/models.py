...
class Contractpayment(models.Model):
    contractid = models.ForeignKey('Contracts', models.DO_NOTHING, db_column='contractID', primary_key=True)  # Field name made lowercase.
...
class Contractorapplications(models.Model):
    ...
    adminid = models.ForeignKey(Administrators, models.DO_NOTHING, db_column='adminID')  # Field name made lowercase.
...
class Contractors(models.Model):
    contractorid = models.ForeignKey(Contractorapplications, models.DO_NOTHING, db_column='contractorID', primary_key=True)  # Field name made lowercase.
    name = models.CharField(max_length=100)
    ssn = models.IntegerField(unique=True)
...
class Contractorsservicerecords(models.Model):
    contractorid = models.ForeignKey(Contractors, models.DO_NOTHING, db_column='contractorID', primary_key=True)  # Field name made lowercase.
...
class Contracts(models.Model):
    ...
    paymentid = models.ForeignKey('Paymentinfo', models.DO_NOTHING, db_column='paymentID')  # Field name made lowercase.
...
class Schedules(models.Model):
    scheduleid = models.ForeignKey(Contractors, models.DO_NOTHING, db_column='scheduleID', primary_key=True)  # Field name made lowercase.
    time_slot = models.ForeignKey('TimeSlots', models.DO_NOTHING, db_column='time_slot_ID')  # Field name made lowercase.
...
class Services(models.Model):
    ...
    categoryserviceid = models.ForeignKey(Servicecategories, models.DO_NOTHING, db_column='categoryServiceID')  # Field name made lowercase.
